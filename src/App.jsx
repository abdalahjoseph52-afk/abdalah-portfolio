...
import { Loader2, Phone, Mail, MapPin, Linkedin, Github, Twitter, Instagram } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div>
                 ...
                 <div className="flex gap-4 flex-wrap">
                    {/* WhatsApp Iko Hapa Sasa - Sio Floating */}
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-xs text-slate-500">
            <p>
              ...
              {/* THE STEALTH DOT (.) - Bonyeza Hapa Kuingia Admin */}
              <button 
